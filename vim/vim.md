...
:移动到行尾。</li><listyle="list−style:inherit!important">g: 移动光标所在屏幕行行尾。
n|: 把光标移到递n列上。
nG: 到文件第n行。
:n<cr> 移动到第n行。
:$<cr> 移动到最后一行。
...
### vim命令树图
##### 大神总结的这个图非常棒，给大神点个赞，大神的博客链接[yangjig](https://www.cnblogs.com/yangjig/p/6014198.html "yangjig")
![vim](http://img.blog.csdn.net/20160712110935064?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center "vim")
...
2.删除单行和多行。
1)单行删除
在命令模式下，将光标移到将要复制的行处，按“dd”删除一行。

2)多行删除
在命令模式下，输入“：set nu”显示行号；命令输入“：14,16d”，删除14~16行。
```
